...
func TestWrongArgumentNumber(t *testing.T) {
	...
	ExpectScriptErr(t, `(defrecord Class (Name string)) (def p (->Class Name "Tom")) (__assoc__)`, `expect 3 argument(s)`)
	ExpectScriptErr(t, `(defrecord Class (Name string)) (def p (->Class Name "Tom")) (__assoc__ 1 2 3)`, `first argument must be record`)
	ExpectScriptErr(t, `(defrecord Class (Name string)) (def p (->Class Name "Tom")) (__assoc__ p 2 333)`, `second argument must be symbol`)
	ExpectScriptErr(t, `(defrecord Class (Name string)) (def p (->Class Name "Tom")) (__assoc__ p 'Name 12)`, `expect string but got int`)
	ExpectScriptErr(t, `(defrecord Class (Name string)) (def p (->Class Name "Tom")) (__assoc__ p 'Name2 12)`, `not found`)
