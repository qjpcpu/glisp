...
func ImportMathUtils(env *glisp.Environment) error {
	env.AddFunctionByConstructor("sla", GetBinaryIntFunction)
	env.AddFunctionByConstructor("sra", GetBinaryIntFunction)
	env.AddFunctionByConstructor("mod", GetBinaryIntFunction)
	env.AddFunctionByConstructor("bit-and", GetBitwiseFunction)
	env.AddFunctionByConstructor("bit-or", GetBitwiseFunction)
	env.AddFunctionByConstructor("bit-xor", GetBitwiseFunction)
	env.AddFunctionByConstructor("bit-not", ComplementFunction)
	env.AddFunctionByConstructor("sll8", GetLogicalShiftFunction)
	env.AddFunctionByConstructor("sll16", GetLogicalShiftFunction)
	env.AddFunctionByConstructor("sll32", GetLogicalShiftFunction)
	env.AddFunctionByConstructor("sll64", GetLogicalShiftFunction)
	env.AddFunctionByConstructor("srl8", GetLogicalShiftFunction)
	env.AddFunctionByConstructor("srl16", GetLogicalShiftFunction)
	env.AddFunctionByConstructor("srl32", GetLogicalShiftFunction)
	env.AddFunctionByConstructor("srl64", GetLogicalShiftFunction)
	return nil
}
