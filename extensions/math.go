...
func ImportMathUtils(env *glisp.Environment) error {
	env.AddFunction("sla", GetBinaryIntFunction)
	env.AddFunction("sra", GetBinaryIntFunction)
	env.AddFunction("mod", GetBinaryIntFunction)
	env.AddFunction("bit-and", GetBitwiseFunction)
	env.AddFunction("bit-or", GetBitwiseFunction)
	env.AddFunction("bit-xor", GetBitwiseFunction)
	env.AddFunction("bit-not", ComplementFunction)
	env.AddFunction("sll8", GetLogicalShiftFunction)
	env.AddFunction("sll16", GetLogicalShiftFunction)
	env.AddFunction("sll32", GetLogicalShiftFunction)
	env.AddFunction("sll64", GetLogicalShiftFunction)
	env.AddFunction("srl8", GetLogicalShiftFunction)
	env.AddFunction("srl16", GetLogicalShiftFunction)
	env.AddFunction("srl32", GetLogicalShiftFunction)
	env.AddFunction("srl64", GetLogicalShiftFunction)
	return nil
}
